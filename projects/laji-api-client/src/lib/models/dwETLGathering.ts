 ...
 */
import { DwETLCoordinates } from './dwETLCoordinates';
import { DwETLDateRange } from './dwETLDateRange';
import { DwETLFact } from './dwETLFact';
import { DwETLGatheringQuality } from './dwETLGatheringQuality';
import { DwETLMediaObject } from './dwETLMediaObject';
import { DwETLTaxonCensus } from './dwETLTaxonCensus';
import { DwETLUnit } from './dwETLUnit';


export interface DwETLGathering {
  gatheringId?: string;
  quality?: DwETLGatheringQuality;
  coordinates?: DwETLCoordinates;
  /**
   * GeoJSON object with custom \"csr\" required property that takes in values WGS84,EUREF,YKJ
   */
  geo?: any;
  eventDate?: DwETLDateRange;
  hourBegin?: number;
  hourEnd?: number;
  team?: Array<string>;
  ...
  taxonCensus?: Array<DwETLTaxonCensus>;
  units?: Array<DwETLUnit>;
}
