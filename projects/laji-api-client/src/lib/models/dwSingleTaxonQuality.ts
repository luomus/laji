...
export interface DwSingleTaxonQuality {
  reliability?: DwSingleTaxonQuality.ReliabilityEnum;
  source?: DwSingleTaxonQuality.SourceEnum;
  message?: string;
}

export namespace DwSingleTaxonQuality {
  export type ReliabilityEnum = 'RELIABLE' | 'LIKELY' | 'NEUTRAL' | 'SUSPICIOUS' | 'UNRELIABLE';
  export const ReliabilityEnum = {
    RELIABLE: 'RELIABLE' as ReliabilityEnum,
    LIKELY: 'LIKELY' as ReliabilityEnum,
    NEUTRAL: 'NEUTRAL' as ReliabilityEnum,
    SUSPICIOUS: 'SUSPICIOUS' as ReliabilityEnum,
    UNRELIABLE: 'UNRELIABLE' as ReliabilityEnum
  };
