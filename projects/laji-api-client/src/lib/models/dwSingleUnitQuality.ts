 ...
 */
import { DwSingleQuality } from './dwSingleQuality';
import { DwSingleTaxonQuality } from './dwSingleTaxonQuality';


export interface DwSingleUnitQuality {
  issue?: DwSingleQuality;
  taxon?: DwSingleTaxonQuality;
