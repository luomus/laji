...
export namespace TaxonCensus {
  export type TaxonCensusTypeEnum =
    'MY.taxonCensusTypeCounted'
    | 'MY.taxonCensusTypeEstimated'
    | 'MY.taxonCensusTypeNotCounted'
    | 'MY.taxonCensusTypeUHEXCounted'
    | 'MY.taxonCensusTypeUHEXNotCounted';
  export const TaxonCensusTypeEnum = {
    TaxonCensusTypeCounted: 'MY.taxonCensusTypeCounted' as TaxonCensusTypeEnum,
    TaxonCensusTypeEstimated: 'MY.taxonCensusTypeEstimated' as TaxonCensusTypeEnum,
    TaxonCensusTypeNotCounted: 'MY.taxonCensusTypeNotCounted' as TaxonCensusTypeEnum,
    TaxonCensusTypeUHEXCounted: 'MY.taxonCensusTypeUHEXCounted' as TaxonCensusTypeEnum,
    TaxonCensusTypeUHEXNotCounted: 'MY.taxonCensusTypeUHEXNotCounted' as TaxonCensusTypeEnum
  };
}
