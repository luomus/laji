...
export interface DwSingleMediaObject {
  mediaType?: DwSingleMediaObject.MediaTypeEnum;
  fullURL?: string;
  thumbnailURL?: string;
  author?: string;
  caption?: string;
...
export namespace DwSingleMediaObject {
  export type MediaTypeEnum = 'IMAGE' | 'AUDIO' | 'VIDEO';
