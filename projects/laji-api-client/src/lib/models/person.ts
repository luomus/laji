...
export interface Person {
   ...
   */
  group?: string;
  roleAnnotation?: Person.RoleAnnotationEnum;
}

export namespace Person {
  export type RoleAnnotationEnum = 'MMAN.expert' | 'MMAN.basic' | 'MMAN.owner';
  export const RoleAnnotationEnum = {
    Expert: 'MMAN.expert' as RoleAnnotationEnum,
    Basic: 'MMAN.basic' as RoleAnnotationEnum,
    Owner: 'MMAN.owner' as RoleAnnotationEnum
  };
}
