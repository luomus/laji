...
export interface FormSchema extends Form {
  ...
  printType?: FormSchema.PrintTypeEnum;
  viewerType?: FormSchema.ViewerTypeEnum;
...
export namespace FormSchema {
  ...
  export const PrintTypeEnum = {
    lineTransect: 'MHL.printTypeLineTransect' as PrintTypeEnum
  };

  export type ViewerTypeEnum =
    'MHL.viewerTypeLineTransect';
  export const ViewerTypeEnum = {
    lineTransect: 'MHL.viewerTypeLineTransect' as PrintTypeEnum
  };
}
