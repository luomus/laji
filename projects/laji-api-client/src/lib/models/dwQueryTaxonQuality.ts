...
export interface DwQueryTaxonQuality {
  reliability?: DwQueryTaxonQuality.ReliabilityEnum;
  source?: DwQueryTaxonQuality.SourceEnum;
  message?: string;
}

export namespace DwQueryTaxonQuality {
