 ...
 */
import { DwSingleDateRange } from './dwSingleDateRange';
import { DwSingleFact } from './dwSingleFact';
import { DwSingleGatheringConversions } from './dwSingleGatheringConversions';
import { DwSingleGatheringDWLinkings } from './dwSingleGatheringDWLinkings';
import { DwSingleGatheringInterpretations } from './dwSingleGatheringInterpretations';
import { DwSingleGatheringQuality } from './dwSingleGatheringQuality';
import { DwSingleMediaObject } from './dwSingleMediaObject';
import { DwSingleTaxonCensus } from './dwSingleTaxonCensus';
import { DwSingleUnit } from './dwSingleUnit';


export interface DwSingleGathering {
  gatheringId?: string;
  gatheringOrder?: number;
  quality?: DwSingleGatheringQuality;
  /**
   * GeoJSON object with custom \"csr\" required property that takes in values WGS84,EUREF,YKJ
   */
  geo?: any;
  eventDate?: DwSingleDateRange;
  hourBegin?: number;
  hourEnd?: number;
  displayDateTime?: string;
  team?: Array<string>;
  conversions?: DwSingleGatheringConversions;
  interpretations?: DwSingleGatheringInterpretations;
  ...
  linkings?: DwSingleGatheringDWLinkings;
  media?: Array<DwSingleMediaObject>;
  mediaCount?: number;
  minutesBegin?: number;
  minutesEnd?: number;
  observerUserIds?: Array<string>;
  taxonCensus?: Array<DwSingleTaxonCensus>;
  units?: Array<DwSingleUnit>;
}
