...
import { DwQueryDocumentDWLinkings } from './dwQueryDocumentDWLinkings';
import { DwQueryDocumentQuality } from './dwQueryDocumentQuality';
import { DwQueryFact } from './dwQueryFact';
import { DwQueryMediaObject } from './dwQueryMediaObject';


export interface DwQueryDocument {
  documentId?: string;
  secureLevel?: DwQueryDocument.SecureLevelEnum;
  secureReasons?: Array<DwQueryDocument.SecureReasonsEnum>;
  partial?: boolean;
  collectionId?: string;
  licenseId?: string;
  quality?: DwQueryDocumentQuality;
  sourceId?: string;
  namedPlaceId?: string;
  ...
  formId?: string;
  linkings?: DwQueryDocumentDWLinkings;
  media?: Array<DwQueryMediaObject>;
  mediaCount?: number;
  secured?: boolean;
}

export namespace DwQueryDocument {
