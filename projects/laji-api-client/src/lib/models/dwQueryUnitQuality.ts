 ...
 */
import { DwQueryQuality } from './dwQueryQuality';
import { DwQueryTaxonQuality } from './dwQueryTaxonQuality';


export interface DwQueryUnitQuality {
  issue?: DwQueryQuality;
  taxon?: DwQueryTaxonQuality;
