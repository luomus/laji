 ...
 */
import { DwQueryDateRange } from './dwQueryDateRange';
import { DwQueryFact } from './dwQueryFact';
import { DwQueryGatheringConversions } from './dwQueryGatheringConversions';
import { DwQueryGatheringDWLinkings } from './dwQueryGatheringDWLinkings';
import { DwQueryGatheringInterpretations } from './dwQueryGatheringInterpretations';
import { DwQueryGatheringQuality } from './dwQueryGatheringQuality';
import { DwQueryMediaObject } from './dwQueryMediaObject';
import { DwQueryTaxonCensus } from './dwQueryTaxonCensus';


export interface DwQueryGathering {
  gatheringId?: string;
  gatheringOrder?: number;
  quality?: DwQueryGatheringQuality;
  /**
   * GeoJSON object with custom \"csr\" required property that takes in values WGS84,EUREF,YKJ
   */
  geo?: any;
  eventDate?: DwQueryDateRange;
  hourBegin?: number;
  hourEnd?: number;
  displayDateTime?: string;
  team?: Array<string>;
  conversions?: DwQueryGatheringConversions;
  interpretations?: DwQueryGatheringInterpretations;
  ...
  linkings?: DwQueryGatheringDWLinkings;
  media?: Array<DwQueryMediaObject>;
  mediaCount?: number;
  minutesBegin?: number;
  minutesEnd?: number;
  observerUserIds?: Array<string>;
  taxonCensus?: Array<DwQueryTaxonCensus>;
}
