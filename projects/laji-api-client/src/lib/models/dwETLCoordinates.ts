...
export interface DwETLCoordinates {
  latMin?: number;
  latMax?: number;
  lonMin?: number;
  lonMax?: number;
  accuracyInMeters?: number;
  type?: DwETLCoordinates.TypeEnum;
}

export namespace DwETLCoordinates {
  export type TypeEnum = 'WGS84' | 'EUREF' | 'YKJ';
  export const TypeEnum = {
    WGS84: 'WGS84' as TypeEnum,
    EUREF: 'EUREF' as TypeEnum,
    YKJ: 'YKJ' as TypeEnum
  };
}
