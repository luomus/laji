 ...
 */
import { CoordinateBioResultAddr } from './coordinateBioResultAddr';
import { CoordinateBioResultGeom } from './coordinateBioResultGeom';


export interface CoordinateBioResult {
  addressComponents?: Array<CoordinateBioResultAddr>;
