...
import { Site, Species, TaxonTypeEnum } from '../../../bsg-shared/models';
...
export class SpeciesSelectionComponent {
  ...
  constructor(
    ...
    this.sites$ = this.userService.isLoggedIn$.pipe(
      switchMap(() => this.bsgApi.getSites(
        [TaxonTypeEnum.bat],
    ...
    const speciesData$ = this.site$.pipe(
      switchMap(site => this.bsgApi.getSpeciesList(this.userService.getToken(), this.translate.getCurrentLang(), {
        page: 1,
        pageSize: 1000,
