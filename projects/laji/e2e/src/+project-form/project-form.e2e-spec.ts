  ...
  describe('when logged in', () => {
    ...
    describe('and has simple option,', () => {
     ...
     it('doesn\'t display sidebar', async (done) => {
      ...
      it('and has no category, canceling document save redirects to Vihko home page', async (done) => {
        await documentFormView.$cancel.click();
        expect(await browser.getCurrentUrl()).toMatch(/\/vihko\/home$/);
    ...
    describe('and has mobile option,', () => {
      ...
      it('displayes about page', async (done) => {
