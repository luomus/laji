...
export class FriendsComponent implements OnInit {
  ...
  removeFriend(userId, block = false) {
    this.translateService.get(['friend.blockConfirm', 'friend.removeConfirm', 'yes']).pipe(
      switchMap(translation => this.dialogService.confirm(block ? translation['friend.blockConfirm'] : translation['friend.removeConfirm'], translation['yes'])),
