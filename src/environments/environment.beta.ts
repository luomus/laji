...
export const environment = {
  ...
  sourceKotka: 'KE.3',
  systemID: 'KE.841',
  formWhitelist: ['JX.519', 'MHL.9', 'MHL.25', 'JX.652', 'MHL.1',  'MHL.3', 'MHL.23', 'MHL.33', 'MHL.6', 'MHL.35', 'MHL.41', 'MHL.43', 'MHL.45', 'MHL.51', 'MHL.53', 'MHL.50', 'MHL.57', 'MHL.59', 'MHL.65'],
  ...
  saveObservations: {
    ...
    birdMonitoringForms: ['MHL.1', 'MHL.61', 'MHL.3'],
