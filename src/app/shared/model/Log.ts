/**
 * API documentation
 * To use this api you need an access token. To get the token, send a post request with your email address to
...
export interface Log {
  ...
  /**
   * Metadata to help with resolving the possible issue
   */
  meta?: any;
}
