 ...
 * resource and one will be send to your. See below for information on how to use this api and if you have any
 * questions you can contact us at helpdesk@laji.fi.  Place refer to [schema.laji.fi](http://schema.laji.fi/)
...
export class AreaApi {
   ...
   */
  public findAll(lang?: string, idIn?: string, page?: string, pageSize?: string, extraHttpRequestParams?: any): Observable<PagedResult<Area>> {
    const path = this.basePath + '/areas';
   ...
   */
  public findById(id: string, lang?: string, extraHttpRequestParams?: any): Observable<Area> {
    const path = this.basePath + '/areas/{id}'
