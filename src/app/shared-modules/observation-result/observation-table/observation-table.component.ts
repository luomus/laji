...
export class ObservationTableComponent implements OnInit, OnChanges {
  ...
  allColumns: ObservationTableColumn[] = [
    ...
    { name: 'gathering.interpretations.biogeographicalProvinceDisplayname', label: 'result.gathering.biogeographicalProvince',
      aggregateBy: 'gathering.interpretations.biogeographicalProvinceDisplayname,' +
    ...
    { name: 'gathering.interpretations.municipalityDisplayname', label: 'observation.form.municipality',
      aggregateBy: 'gathering.interpretations.municipalityDisplayname,' +
    ...
    { name: 'gathering.higherGeography'},
    { name: 'gathering.eventDate.begin'},
    { name: 'gathering.eventDate.end'},
    { name: 'gathering.conversions.team'},
    { name: 'gathering.conversions.day'},
    { name: 'gathering.conversions.month'},
    { name: 'gathering.conversions.year'},
    { name: 'gathering.conversions.decade'},
    { name: 'gathering.conversions.century'},
